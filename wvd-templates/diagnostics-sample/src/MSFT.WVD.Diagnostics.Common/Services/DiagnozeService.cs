...
namespace MSFT.WVD.Diagnostics.Common.Services
{
    public class DiagnozeService
    {
        ...
        public async Task<List<ConnectionActivity>> GetConnectionActivities(string accessToken, string upn, string tenantGroupName, string tenant, string startDatetime, string endDatetime, string outcome)
        {
            ...
            _logger.LogInformation($"Service call to get connection activities of user {sanitizedUpn} of Tenant {sanitizedTenant} within tenant group {sanitizedTenantGroupName} ");
            ...
            {
                _logger.LogError($"Service call to get connection activities of user {sanitizedUpn} of Tenant {sanitizedTenant} within tenant group {sanitizedTenantGroupName} is failed. Error : {result} ");
